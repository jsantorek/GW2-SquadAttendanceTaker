...
void OptionsRender()
{
    ...
    if (ImGui::TreeNode("Recording input"))
    {
        ...
        ImGui::RadioButton("Single snapshot", (int *)&G::Options.MonitoringMode,
                           SAT::Options::AttendenceMonitoringMode::SingleSnapshot);
        ImGui::SameLine();
        ImGui::RadioButton("Continuous recording", (int *)&G::Options.MonitoringMode,
                           SAT::Options::AttendenceMonitoringMode::ContinuousRecording);
        if (G::Options.MonitoringMode == SAT::Options::AttendenceMonitoringMode::ContinuousRecording)
        {
            ImGui::DragInt("Period between presence checks", &G::Options.PeriodBetweenPresenceChecks, 1, 1, 120,
                           "%d seconds", ImGuiSliderFlags_AlwaysClamp);
        }
        ImGui::TreePop();
    }
